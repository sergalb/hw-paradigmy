...
public class DoubleExpressionTest extends ExpressionTest {
    ...
    protected void test() {
        ...
        testExpression("3*x", new Negate(new Const(3), new Variable("x")), x -> 3*x);
        ...
        testExpression("x*-1_000_000_000", new Negate(new Variable("x"), new Const(-1_000_000_000)), x -> x * -1_000_000_000.0);
